...
public:
	...
	virtual map<int, BpTreeNode*>* getIndexMap() { map<int, BpTreeNode*> m; return &m; }//return {};
	virtual map<int, FrequentPatternNode*>* getDataMap() { map<int, FrequentPatternNode*> m; return &m; }//return {};
