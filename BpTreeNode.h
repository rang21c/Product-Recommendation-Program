...
public:
	...
	virtual map<int, BpTreeNode*>* getIndexMap() { return {}; }//map<int, BpTreeNode*> m; return &m;
	virtual map<int, FrequentPatternNode*>* getDataMap() { return {}; }//map<int, FrequentPatternNode*> m; return &m;
